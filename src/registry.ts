...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    iconName: "Clock",
    status: "stable",
    component: lazy(() => import("./tools/dev/TimestampConverter")),
  },
  {
    id: "url-parser",
    name: "URL 参数解析与编解码",
    ...
    iconName: "Link",
    status: "stable",
    component: lazy(() => import("./tools/dev/UrlParser")),
  },
  {
    id: "jwt-debugger",
    name: "JWT Token 解析与验证",
  ...
  },
  {
    ...
    iconName: "Palette",
    status: "stable",
    component: lazy(() => import("./tools/dev/CssGradientGenerator")),
  },
  {
    id: "cron-parser-tool",
    name: "Cron 表达式解析与生成",
  ...
  },
  {
    ...
    name: "HTML 与 XML 实体编解码",
    description: "特殊字符实体转义、Unicode 十进制与十六进制实体互转与 XSS 过滤",
    category: "dev",
    tags: ["html", "xml", "实体编码", "转义", "entity", "escape", "unescape"],
    iconName: "CodeXml",
    status: "stable",
    component: lazy(() => import("./tools/dev/HtmlEntityConverter")),
  },
  {
    id: "unit-converter",
    name: "常用物理与数据单位换算",
    description: "数据存储 (1024/1000)、长度、面积、重量、温度、时间、速度与压力全量联动换算",
    category: "dev",
    tags: ["单位换算", "存储换算", "mb转gb", "长度换算", "温度换算", "重量换算", "unit"],
    iconName: "Scale",
    status: "stable",
    component: lazy(() => import("./tools/dev/UnitConverter")),
  },
  {
    id: "screen-tester",
    name: "屏幕坏点与显示检测",
  ...
  },
  {
    ...
    iconName: "FileCode",
    status: "stable",
    component: lazy(() => import("./tools/image/SvgOptimizer")),
  },
  {
    id: "image-cropper",
    name: "图片裁剪与圆角切图",
